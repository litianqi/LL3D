...
public:
  ...
  virtual void vertexShaderBytecode(const void** pShaderByteCode,
                                    size_t* pByteCodeLength) = 0;
...
public:
  ...
  void vertexShaderBytecode(const void** byte_code,
                            size_t* byte_code_length) override;
