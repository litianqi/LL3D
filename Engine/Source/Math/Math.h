...
template <>
struct less<LL3D::Math::Vector2>
{
  bool operator()(const LL3D::Math::Vector2& V1,
                  const LL3D::Math::Vector2& V2) const
  {
...
template <>
struct less<LL3D::Math::Vector3>
{
  bool operator()(const LL3D::Math::Vector3& V1,
                  const LL3D::Math::Vector3& V2) const
  {
    return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)) ||
...
template <>
struct less<LL3D::Math::Vector4>
{
  bool operator()(const LL3D::Math::Vector4& V1,
                  const LL3D::Math::Vector4& V2) const
  {
    return (
...
template <>
struct less<LL3D::Math::Matrix>
{
  bool operator()(const LL3D::Math::Matrix& M1,
                  const LL3D::Math::Matrix& M2) const
  {
    if (M1._11 != M2._11)
...
template <>
struct less<LL3D::Math::Plane>
{
  bool operator()(const LL3D::Math::Plane& P1,
                  const LL3D::Math::Plane& P2) const
  {
    return (
...
template <>
struct less<LL3D::Math::Quaternion>
{
  bool operator()(const LL3D::Math::Quaternion& Q1,
                  const LL3D::Math::Quaternion& Q2) const
  {
    return (
...
template <>
struct less<LL3D::Math::Color>
{
  bool operator()(const LL3D::Math::Color& C1,
                  const LL3D::Math::Color& C2) const
  {
    return (
...
template <>
struct less<LL3D::Math::Viewport>
{
  bool operator()(const LL3D::Math::Viewport& vp1,
                  const LL3D::Math::Viewport& vp2) const
  {
    if (vp1.x != vp2.x)
      return (vp1.x < vp2.x);
    if (vp1.y != vp2.y)
