...
bool
Keyboard::isHeldingDown(KeyCode key)
{
  return s_heldingDown[key];
}

bool
Keyboard::isPressed(KeyCode key)
{
  return s_pressed[key];
}

bool
Keyboard::isReleased(KeyCode key)
{
