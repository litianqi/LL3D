...
void
Transform::setParentTransform(const Transform* parent_transform)
{
  parentTransform_ = parent_transform;
}

void
Transform::setLocalPosition(Math::Vector3 value)
{
  position_ = value;
}

void
Transform::setLocalRotation(Math::Vector3 value)
{
  rotation_ = value;
}

void
Transform::setLocalScale(Math::Vector3 value)
{
  scale_ = value;
}

void
Transform::setLocalMatrix(Math::Matrix value)
{
...
void
Transform::setPosition(Math::Vector3 value)
{
  if (parentTransform_)
...
void
Transform::setRotation(Math::Vector3 value)
{
  if (parentTransform_)
...
void
Transform::setScale(Math::Vector3 value)
{
  if (parentTransform_)
...
void
Transform::setMatrix(Math::Matrix value)
{
...
Math::Vector3
Transform::localUpVec() const
{
  auto rotation = localRotation();
  auto matrix =
    Math::Matrix::CreateFromYawPitchRoll(rotation.y, rotation.x, rotation.z);
  return Math::Vector3::TransformNormal(Math::Vector3::Up, matrix);
}

Math::Vector3
Transform::localRightVec() const
{
  auto rotation = localRotation();
  auto matrix =
    Math::Matrix::CreateFromYawPitchRoll(rotation.y, rotation.x, rotation.z);
...
Math::Vector3
Transform::localForwardVec() const
{
  auto rotation = localRotation();
  auto matrix =
    Math::Matrix::CreateFromYawPitchRoll(rotation.y, rotation.x, rotation.z);
...
Math::Quaternion
Transform::rotationQuaternion() const
{
  return Math::Quaternion::CreateFromYawPitchRoll(rotation_.y, rotation_.x,
                                                  rotation_.z);
}
...
void
Transform::writeToEffect() const
{
  writeToEffect(matrix());
}

void
Transform::writeToEffect(Math::Matrix world)
{
  s_effect->setWorld(world);
}

Math::Matrix
Transform::composeMatrix(Math::Vector3 position, Math::Vector3 rotation,
                         Math::Vector3 scale)
{
  auto r =
    Math::Matrix::CreateFromYawPitchRoll(rotation.y, rotation.x, rotation.z);
